...
export default function PasswordStrengthArena() {
  ...
  const analyzePassword = (pwd) => {
    ...
    const hasSequence = /(abc|bcd|cde|def|123|234|345|456|567|678|789|qwe|wer|ert|rty|tyu|yui|uio|iop|asd|sdf|dfg|fgh|ghj|hjk|jkl|zxc|xcv|cvb|vbn|bnm)/i.test(pwd);
    ...
    <main className="min-h-screen" style={{ backgroundColor: '#0B1220' }}>
      <div className="max-w-6xl mx-auto px-6 py-10">
        <div className="flex items-center gap-4 mb-8">
          ...
          <h1 className="text-2xl font-bold text-white">Password Strength Arena</h1>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          <div className="lg:col-span-7 space-y-6">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-center lg:text-left mb-2" style={{ color: '#E7ECF5' }}>
                Test Your Password's Strength
              </h2>
              <p className="text-center lg:text-left" style={{ color: '#9FB1CC' }}>
            ...
            >
              <label className="block text-sm font-medium mb-3" style={{ color: '#E7ECF5' }}>
                Enter Password
              </label>
              ...
              <div className="grid grid-cols-4 gap-2">
                {strengthLevels.map((level, idx) => (
                  <button
                    ...
                    style={{
                      backgroundColor: idx <= analysis.strength ? strengthColors[idx] : '#0B1220',
                      color: idx <= analysis.strength ? '#fff' : '#9FB1CC',
                      borderWidth: '1px',
                      borderColor: idx <= analysis.strength ? strengthColors[idx] : '#1F2A44',
            ...
            >
              ...
              <div className="text-center">
                <p className="text-sm font-medium mb-2" style={{ color: '#9FB1CC' }}>
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            >
              <h3 className="text-xl font-bold mb-6" style={{ color: '#E7ECF5' }}>
                Password Checklist
              </h3>
              
              <div className="space-y-4">
                {[
                  { label: 'At least 12 characters', pass: analysis.length >= 12 },
                  { label: 'Includes uppercase letters', pass: analysis.hasUpper },
                  { label: 'Includes lowercase letters', pass: analysis.hasLower },
            ...
            >
              ...
              <div className="space-y-3">
                {suggestions.map((suggestion, idx) => (
                  <div 
                    key={idx}
                    className="p-4 rounded-xl transition-all hover:scale-[1.02] hover:shadow-lg cursor-default"
                    style={{
